...
class hawk:
    def __init__(self):
        ...
        rPanel = box(pos=center, axis=vector(0, 0.1, 1), length=0.2, width=2, height=10, color=color.orange)
        lPanel = box(pos=center, axis=vector(0, -0.1, 1), length=0.2, width=2, height=10, color=color.orange)
